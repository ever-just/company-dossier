...
const steps = `<div class="steps">
  <article class="step sk reveal"><div class="big">1</div>${icon('i-glass')}<h3>Open companydossier.lol/generate</h3><p>Load the web app in any browser — desktop or phone. Nothing to install.</p><svg class="arrow" viewBox="0 0 30 24" aria-hidden="true"><path d="M2 12h22M17 5l8 7-8 7"/></svg></article>
...
<section class="sec phero tight">
  <div class="wrap">
    ...
    <p class="lede">The Company Dossier web app at <strong>companydossier.lol/generate</strong> turns a company name into a complete, sourced profile — people, hiring, money, locations, tech, news and risk — without a single install. Open a tab, name a business, read the file. Free, public sources only.</p>
    <div class="cta-row" style="display:flex;flex-wrap:wrap;gap:14px;margin-top:24px">
      <a class="btn solid" href="${SITE.webapp}" target="_blank" rel="noopener">Open companydossier.lol/generate ${ext}</a>
...
<section class="sec">
  <div class="wrap narrow">
    ...
    <div class="faq">
      <article class="qa sk reveal"><h3><span class="marker">Q.</span> Do I need to install anything?</h3><p>No. The web app runs entirely in your browser at companydossier.lol/generate. There's nothing to download, no extension to add, and no command line involved.</p></article>
...
${ctaFinal('Open a file in your browser.', 'companydossier.lol/generate · one search, the whole story, sourced.')}
`;
...
export default {
  ...
  title: 'Company Dossier web app — company research in your browser (companydossier.lol/generate)',
  description: 'The Company Dossier web app at companydossier.lol/generate builds a complete, sourced company profile in your browser — people, hiring, money, locations, tech, news and risk. Free, no install, public sources only.',
  jsonld: [
    {
