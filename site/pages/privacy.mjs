...
<section class="sec" style="padding-top:24px">
  <div class="narrow">
    <div class="prose">
      ...
      <h2>The in-browser widget at /generate</h2>
      <p>When you generate a dossier in your browser at <a href="/generate/">/generate</a>, your <strong>Claude API key and the generated output stay in your browser</strong>. Requests go directly from your browser to Anthropic's API. We don't store your key, your prompts or the resulting dossier on any server of ours. Anthropic's handling of those requests is governed by Anthropic's own terms and privacy policy.</p>
