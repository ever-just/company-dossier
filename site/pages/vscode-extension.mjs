...
<span class="c"># install from source</span>
...
const steps = `<div class="steps">
  <article class="step sk reveal"><div class="big">1</div>${icon('i-glass')}<h3>Install it</h3><p>Search "Company Dossier" in the Extensions panel, or clone the repo and run it from source.</p><svg class="arrow" viewBox="0 0 30 24" aria-hidden="true"><path d="M2 12h22M17 5l8 7-8 7"/></svg></article>
...
<section class="sec phero tight">
  <div class="wrap">
    ...
    <div class="cta-row" style="display:flex;flex-wrap:wrap;gap:14px;margin-top:24px">
      <a class="btn solid" href="${SITE.repoVscode}" target="_blank" rel="noopener">View the repo ${ghIcon}</a>
      <a class="btn" href="/get/">All four ways ${arrow}</a>
    </div>
